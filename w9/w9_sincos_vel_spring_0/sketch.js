...
//apply the on-going force according to the prev ball to update the velocity
//what if the agent goes like a flower?
...
function setup() {
  ...
  for (var i = 0; i < numOfBalls; i++) {
    var pos = createVector(width/2, height/2);//calPos(i * STEP, width / 2, height / 2);
