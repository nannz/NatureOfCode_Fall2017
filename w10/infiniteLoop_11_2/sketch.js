/*The flow field is flowing the agent*/
...
function draw() {
  ...
  for (var y = 0; y < rows; y++) {
    for (var x = 0; x < cols; x++) {
      ...
      //the flowField is following the pos of the agent.
      var pos = createVector(x * scl, y * scl);
      var agentPos = a.pos;
      var vFromAgent = p5.Vector.sub(agentPos, pos);
      //v.normalize();
      //v.mult(0.6);
